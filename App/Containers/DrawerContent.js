...
class DrawerContent extends Component {
  ...
  handlePressSettings = () => {
    NavigationActions.drawerClose()
    NavigationActions.userProfileEntityDetail({entityId: this.props.userProfile.id})
  }
  ...
  render () {
    const disabled = this.props.userProfile ? false : true
    return (
      <ScrollView style={styles.container}>
        ...
        {this.props.loggedIn && (<DrawerButton text='Profile' disabled={disabled} onPress={this.handlePressSettings} />)}
